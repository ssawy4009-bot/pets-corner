...
const products = [
    ...
    // ===================== القطط - دراي فود =====================
    { id: 17, name: 'Vet Star دراي فود - 1 كجم', price: 100, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/Vet star.webp', variants: null },
    { id: 18, name: 'Alpha دراي فود - 1 كجم', price: 170, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/Alpha.webp', variants: null },
    { id: 19, name: 'Casita دراي فود - 1 كجم', price: 100, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/Casita.webp', variants: null },
    { id: 20, name: 'Doodzy دراي فود - 1 كجم', price: 100, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/shopping (2).webp', variants: null },
    ...
    { id: 22, name: 'aleef (Kitten) دراي فود - 1 كجم', price: 150, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/shopping (3).webp', variants: null },
    { id: 23, name: 'aleef (Adult) دراي فود - 1 كجم', price: 140, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/aleef.webp', variants: null },
    { id: 24, name: 'Pro Performance (Adult Sterilised) - 2 كجم', price: 650, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/pro performance adult(1).jpg', variants: null },
    { id: 25, name: 'Pro Performance (Kitten) - 2 كجم', price: 650, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/Pro performance kitten.webp', variants: null },
    { id: 26, name: 'Migma دراي فود - 1 كجم', price: 110, categories: ['cat'], subcategory: 'dry-food', image: 'منتجات/القطط/Migma dray cat .webp', variants: null },
    ...
    { id: 28, name: 'فرشاه سيليكون', price: 100, categories: ['cat', 'dog'], subcategory: 'brush', image: 'منتجات/القطط/shopping (8).webp', variants: null },
    { id: 29, name: 'فلاية Terminator', price: 50, categories: ['cat', 'dog'], subcategory: 'brush', image: 'منتجات/القطط/download (2).jpg', variants: null },
    ...
    // ===================== الكلاب =====================
    { id: 38, name: 'Migma دراي فود كلاب', price: 850, categories: ['dog'], subcategory: 'dry-food', image: 'منتجات/القطط/Migma dray.webp', variants: null },
